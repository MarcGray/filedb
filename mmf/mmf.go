...
//http://stackoverflow.com/questions/11622438/how-do-you-mmap-a-file-bigger-than-2gb-in-go
...
func (mmf *Mmf) OpenAndMapWriter(path string, sz int64, create bool) (bool, error) {
	...
	//log.Println("original file sz", sz)

	created := false
	//log.Println("open and map to file size", sz)
	//var err error
	perm := os.O_RDWR
	if create {
		perm |= os.O_CREATE
